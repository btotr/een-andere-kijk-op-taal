...
taalgevoel zou jij je beter moeten kunnen uitdrukken, minder spelfouten maken en andermans
...
worden. Zowel relaties als concepten kunnen verder gespecificeerd worden (specificeer woorden) en context aan
gegeven worden (context woorden). Het schema ziet er als volgd uit:

\reuseMPgraphic{model}{
    lc="concept",
    r="relatie",
    rc="concept",
    lcx="context",rlcx="context",rcx="context",ls="specificeer",rls="",rs="specificeer",meta=""}
...
In de in "Mats kookt" is Mats het zelfstandig naamwoord en kookt het werkwoord. Dat een woord bij een
bepaalde lexicaal woordsoort hoort hangt af van de context.
In de zin "Koken is leuk"  is “koken” een zelfstandig naamwoord en “is” het werkwoord. Koken is hier dus geen
...
Een voorbeeld van zo'n zin is "Mats kookt pasta".
Hierbij is pasta het lijdend voorwerp, er een duidelijke relatie (de persoonsvorm)
...
In de zin "Kleine Mats kookt verse pasta" wordt duidelijk dat het om kleine Mats gaat — niet de grote. Ook gaat het om verse
pasta.
...
In de zin "Mijn Mats kookt veel pasta" geef je met de woorden “mijn” en “veel” context aan. Het gaat om mijn Mats maar je zegt
...
gemaakt zolals de zin: "Mats kookt pasta als hij jarig is".
...
de volgorde van een hoofdzin en bijzin is niet relevant. 
...
wel een interessant gegeven. Je zou ook kunnen zeggen de frase “is jaren” een zogenoemde
...
\blank
. \framed{Op de camping} kookt Mats pasta.
\blank
. Mats kookt \framed{op de camping} pasta.
\blank
. Pasta kookt Mats \framed{op de camping}.
...
\chapter{Herkenning}
Met dit model is het herkennen van woorden een stuk eenvoudiger voor mij omdat ik de
...
hoe je het model in de praktijk gebruikt. Door een aantal voorbeelden te gebruiken laat ik zien hoe ik deze lees en interpreteer volgens het model.
...
\blank
\inleftmargin\zin Vorig jaar {\em trachtte} een inbreker ons huis binnen te dringen
...
.
\blank
\inleftmargin\zin Lenie {\em stond} meer dan een kwartier op de bus te wachten
...
\blank
\inleftmargin\zin Heb je gezien, wie daar in de snackbar {\em bediend}?
...
\blank
\inleftmargin\zin Vroeger {\em werkten} men tot 's avonds laat.

\reuseMPgraphic{model}{
    lc="men",
    r="werkten",
    rc="tot 's avonds laat",
    lcx="",rlcx="vroeger",rcx="",ls="",rls="",rs="",meta=""}

In deze zin is het onderwerp lastig te bepalen doordat het lijdend voorwerp een frase is. 
Het onderwerp is niet "vroeger" maar "men". men is meervoud dus daarom werkten.
